...
namespace SRTPluginProviderRE2
{
    ...
    public static class GameHashes
    {
        ...
        private static readonly byte[] re2WW_11636119_2 = new byte[32] { 0x6C, 0xAA, 0xA8, 0x15, 0xBF, 0x9E, 0x95, 0xF8, 0xA8, 0x41, 0xBC, 0x81, 0xFD, 0xF2, 0x9F, 0xEC, 0x55, 0xE8, 0x36, 0xC8, 0x7B, 0xAB, 0x8A, 0x76, 0xD5, 0x5C, 0x69, 0xBE, 0xF9, 0xAD, 0xA9, 0x41 };
        // Latest DX11 Build
        ...
        public static GameVersion DetectVersion(string filePath)
        {
            ...
            if (checksum.SequenceEqual(re2WW_11636119) || checksum.SequenceEqual(re2WW_11636119_2))
            {
